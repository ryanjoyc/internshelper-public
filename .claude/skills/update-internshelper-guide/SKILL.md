...
The Claude guide lives at `.claude/skills/internshelper-guide/SKILL.md`; the Codex-compatible
mirror lives at `.agents/skills/internshelper-guide/SKILL.md`. Keep their technical content
...
1. **Read both guide copies:** `.claude/skills/internshelper-guide/SKILL.md` and
   `.agents/skills/internshelper-guide/SKILL.md`.
...
5. **Fix cross-references** if a name changed — the `add-source` / `review-internships` /
   `update-internshelper-guide` pointers, root `CLAUDE.md` / `AGENTS.md`, and `docs/README.md`.

...
This guide contains the detailed installation, configuration, dashboard, automation, and testing instructions for internsHELPer. For the short project introduction and agent-first workflow, start with the [root README](../README.md).
...
The rest of this guide is the manual/advanced reference behind that one command.
...
generated [case catalog](availability-verification-catalog.md), coverage matrix, and mutant
